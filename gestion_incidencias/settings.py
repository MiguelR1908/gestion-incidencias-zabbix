...
SECRET_KEY = 'django-insecure-2&y0^(5^q=uw)omkn!wqwd+@dhp@c)vj$uvb(ch)c)rh#n%@m('
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "incidencias.context_processors.notificaciones_globales",
            ],
        },
    },
]
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="gestion_incidencias_dev"),
