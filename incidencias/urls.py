...
urlpatterns = [
    ...
    path("reportes/nodos-componentes/",views.reporte_nodos_componentes,name="reporte_nodos_componentes",),
    path("reportes/sla-tiempos/",views.reporte_sla_tiempos,name="reporte_sla_tiempos",),
    path(
        "reportes/tecnicos/",
...
# ==========================================================
    ...
    path("sla/configuracion/",views.sla_configuracion_lista,name="sla_configuracion_lista",),

    path("sla/configuracion/<int:sla_id>/editar/",views.sla_configuracion_editar,name="sla_configuracion_editar",),
# ==========================================================
# NOTIFICACIONES
# ==========================================================
